...
from controllers.pointControllers import delete_all_points, seed_points, fetch_points, fetch_points_by_disease, fetch_points_by_disease_by_user
router = APIRouter()
...
# GET       /points/disease
router.add_api_route("/disease/user", methods=['GET'], endpoint=fetch_points_by_disease_by_user)
