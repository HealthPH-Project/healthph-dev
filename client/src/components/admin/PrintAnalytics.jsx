...
const PrintAnalytics = forwardRef(
  ({ showPrint = false, data, dateTable }, ref) => {
                            ...
                            content={({ x, y, value }) => {
                              return (
                                <text
                                  x={x}
                                  y={y - 5}
                                  className="recharts-text recharts-cartesian-axis-tick-value text-[12px] font-inter"
                                  fill="#666"
                                >
                                  <tspan>{value}</tspan>
                                </text>
